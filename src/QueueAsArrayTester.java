/* NAME:        SWAPNA MUKKAMALLA
   ...
   DATE:        09/16/2019
   DESCRIPTION: IMPLEMENTED THE CLASS TO TEST QUEUEASARRAY CLASS
                ENQUEUE SOME STRINGS AND DISPLAYING THE QUEUE
...
public class QueueAsArrayTester {
    public static void main(String[] args) {
        QueueAsArray<String> things = new QueueAsArray<String>();            // Make a new empty Queue called "things"
        ...
        StdOut.println("Queue still has " + things.size() + " items in it.");
